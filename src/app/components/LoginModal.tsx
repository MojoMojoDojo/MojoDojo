          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="text-center mb-8">
                <img src={logoImage} alt="MojoDojo" className="h-16 w-16 mx-auto mb-4" />
              ...
              <form onSubmit={handleSubmit} className="space-y-4 mb-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black border-2 border-zinc-700 rounded-lg text-white 
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#D4AF37] text-black font-semibold py-3 px-6 rounded-lg 
                           hover:bg-[#B8941F] transition-all duration-300 
              ...
              <button
                disabled
                className="w-full mb-6 px-4 py-3 bg-zinc-800 text-gray-500 font-medium rounded-lg 
